...
double Ortoedro::obtieneVertices() {
    cout << "x = " << primero.getInfIzq().getX() << " y = " << primero.getInfIzq().getY() << " z = "
         << primero.getInfIzq().getZ() << endl;
    cout << "x = " << primero.getSupDer().getX() << " y = " << primero.getSupDer().getY() << " z = "
         << primero.getSupDer().getZ() << endl;
    cout << "x = " << segundo.getInfIzq().getX() << " y = " << segundo.getInfIzq().getY() << " z = "
         << segundo.getInfIzq().getZ() << endl;
    cout << "x = " << segundo.getSupDer().getX() << " y = " << segundo.getSupDer().getY() << " z = "
         << segundo.getSupDer().getZ() << endl;
    cout << "x = " << tercero.getInfIzq().getX() << " y = " << tercero.getInfIzq().getY() << " z = "
         << tercero.getInfIzq().getZ() << endl;
    cout << "x = " << sexto.getInfIzq().getX() << " y = " << sexto.getInfIzq().getY() << " z = "
         << sexto.getInfIzq().getZ() << endl;
    cout << "x = " << cuarto.getSupDer().getX() << " y = " << cuarto.getSupDer().getY() << " z = "
         << cuarto.getSupDer().getZ() << endl;
    cout << "x = " << quinto.getSupDer().getX() << " y = " << quinto.getSupDer().getY() << " z = "
         << quinto.getSupDer().getZ() << endl;
}
